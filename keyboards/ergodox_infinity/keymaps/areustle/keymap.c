 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  '"  |AltShf| LCtl | LGUI |                                       | Left | Down |  Up  | Right| ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | LGui |       | Alt  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 | Backs| CTRL | Home |       | PgUp |  Shift | Space|
 *                                 | pace/|  /   |------|       |------|   /    |  /   |
 *                                 | MEDIA| ESC  | End  |       | PgDn |  Enter | SYMB |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        LT(SYMB,KC_GRV),KC_QUOT,      LALT(KC_LSFT),  KC_LCTL,KC_LGUI,
                                              ALT_T(KC_APP),  KC_LGUI,
                                                              KC_HOME,
                               LT(MDIA, KC_BSPC),CTL_T(KC_ESC),KC_END,
        // right hand
             KC_RABK,    KC_6,   KC_7,    KC_8,    KC_9,   KC_0,             KC_MINS,
             ...
             KC_PGUP,
             KC_PGDN,SFT_T(KC_ENT), LT(SYMB, KC_SPC)
    ),
